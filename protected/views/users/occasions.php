	...
	?>
		<div class="gift">
			...
			<div class="f_l">
				...
				<div class="f_l m_r_10"><i class="icon-time jreminder" user_remind_date="<?php echo ($oca_values['remind_date']=='00/00/0000'?'':$oca_values['remind_date']);?>" user_occ_id="<?php echo $oca_values['user_occ_id'];?>"></i></div>
